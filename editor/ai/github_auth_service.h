...
class GitHubAuthService : public AIOAuthService {
	GDCLASS(GitHubAuthService, AIOAuthService);
...
public:
	static GitHubAuthService *get_singleton();
...
private:
	static GitHubAuthService *singleton;
};
