...
AppComments=Jundot Engine editor
ChangesEnvironment=yes
DefaultDirName={localappdata}\Jundot
DefaultGroupName=Jundot Engine
AllowNoIcons=yes
UninstallDisplayIcon={app}\{#MyAppExeName}
#ifdef App32Bit
  OutputBaseFilename=jundot-setup-x86
#else
  OutputBaseFilename=jundot-setup-x86_64
...
Name: "modifypath"; Description: "Add Jundot to PATH environment variable"
