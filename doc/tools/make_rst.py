...
JUNDOT_DOCS_PATTERN = re.compile(r"^\$DOCS_URL/(.*)\.html(#.*)?$")
...
# `scripts/extract_classes.py` (jundotengine/jundot-editor-l10n repo) to include them in the source POT file.
BASE_STRINGS = [
    "All classes",
    "Globals",
    "Nodes",
    ...
    "No return value.",
    "There is currently no description for this class. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
    "There is currently no description for this signal. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
    "There is currently no description for this enum. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
    "There is currently no description for this constant. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
    "There is currently no description for this annotation. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
    "There is currently no description for this property. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
    "There is currently no description for this constructor. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
    "There is currently no description for this method. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
    "There is currently no description for this operator. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
    "There is currently no description for this theme property. Please help us by `contributing one <https://contributing.jundotengine.org/en/latest/documentation/class_reference.html>`__!",
...
def make_rst_class(class_def: ClassDef, state: State, dry_run: bool, output_dir: str) -> None:
    ...
    with open(
        ...
        if not writing_translation:  # Skip for translations to reduce diff.
            ...
            source_github_url = f"https://github.com/jundotengine/jundot/tree/{git_branch}/{source_xml_path}"
            generator_github_url = f"https://github.com/jundotengine/jundot/tree/{git_branch}/doc/tools/make_rst.py"

            f.write(".. DO NOT EDIT THIS FILE!!!\n")
            f.write(".. Generated automatically from Jundot engine sources.\n")
...
def make_link(url: str, title: str) -> str:
    match = JUNDOT_DOCS_PATTERN.search(url)
    if match:
        groups = match.groups()
