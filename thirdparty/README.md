...
- `0001-build-fixes.patch` ([GH-81197](https://github.com/jundotengine/jundot/pull/81197))
- `0002-jundot-fsr2-options.patch` ([GH-81197](https://github.com/jundotengine/jundot/pull/81197))
...
- `0001-external-zstd-pr344.patch` ([GH-73441](https://github.com/jundotengine/jundot/pull/73441))
- `0002-external-tinyexr.patch` ([GH-97582](https://github.com/jundotengine/jundot/pull/97582))
- `0003-remove-tinydds-qoi.patch` ([GH-97582](https://github.com/jundotengine/jundot/pull/97582))
- `0004-clang-warning-exclude.patch` ([GH-111346](https://github.com/jundotengine/jundot/pull/111346))
- `0005-unused-typedef.patch` ([GH-111445](https://github.com/jundotengine/jundot/pull/111445))
- `0006-explicit-includes.patch` ([GH-111557](https://github.com/jundotengine/jundot/pull/111557))
...
- `0001-disable-exceptions.patch` ([GH-80796](https://github.com/jundotengine/jundot/pull/80796))
- `0002-llvm-21-header.patch` ([GH-113850](https://github.com/jundotengine/jundot/pull/113850))
...
- `0001-revert-bc6h-reorg.patch` ([GH-73715](https://github.com/jundotengine/jundot/pull/73715))
...
- `0001-mingw-support.patch` ([GH-83452](https://github.com/jundotengine/jundot/pull/83452))
...
- `0001-win7-8-dynamic-load.patch` ([GH-88496](https://github.com/jundotengine/jundot/pull/88496))
...
- `0001-ciso646-version.patch` ([GH-105913](https://github.com/jundotengine/jundot/pull/105913))
...
`dr_bridge.h` is a Jundot file and should be preserved on updates.
...
- All `.cpp` files listed in `modules/raycast/jundot_update_embree.py`
- All header files in the directories listed in `modules/raycast/jundot_update_embree.py`
- All config files listed in `modules/raycast/jundot_update_embree.py`
- `LICENSE.txt`

Patches:

- `0001-disable-exceptions.patch` ([GH-48050](https://github.com/jundotengine/jundot/pull/48050))
- `0002-jundot-config.patch` ([GH-88783](https://github.com/jundotengine/jundot/pull/88783))
- `0003-emscripten-nthreads.patch` ([GH-69799](https://github.com/jundotengine/jundot/pull/69799))
- `0004-mingw-no-cpuidex.patch` ([GH-92488](https://github.com/jundotengine/jundot/pull/92488))
- `0005-mingw-llvm-arm64.patch` ([GH-93364](https://github.com/jundotengine/jundot/pull/93364))
- `0006-explicit-includes.patch` ([GH-111557](https://github.com/jundotengine/jundot/pull/111557))

The `modules/raycast/jundot_update_embree.py` script can be used to pull the
...
- `LICENSE` file
- Added 3 files `enet_jundot.cpp`, `enet/enet_jundot.h`, and `enet/enet_jundot_ext.h`,
  providing ENet socket implementation using Jundot classes, allowing IPv6 and DTLS.

Patches:

- `0001-jundot-socket.patch` ([GH-7985](https://github.com/jundotengine/jundot/pull/7985))
...
- `0001-remove-bc7enc.patch` ([GH-101362](https://github.com/jundotengine/jundot/pull/101362))
...
- `0001-fix-warnings.patch` ([GH-111679](https://github.com/jundotengine/jundot/pull/111679))
...
- `0001-enable-both-gl-and-gles.patch` ([GH-72831](https://github.com/jundotengine/jundot/pull/72831))
- `0002-revert-egl_static-removal.patch` ([GH-107312](https://github.com/jundotengine/jundot/pull/107312))
...
- `0001-apple-disable-absolute-paths.patch` ([GH-92010](https://github.com/jundotengine/jundot/pull/92010))
- `0002-apple-m1-msaa-fix.patch` ([GH-115893](https://github.com/jundotengine/jundot/issues/115893))
...
- `0001-jundot-changes.patch` ([GH-98750](https://github.com/jundotengine/jundot/pull/98750))
...
- The `icudt_jundot.dat` built with the provided `jundot_data.json` config file (see
...
3. Reconfigure ICU with custom data config:
   `ICU_DATA_FILTER_FILE={JUNDOT_SOURCE}/thirdparty/icu4c/jundot_data.json ./runConfigureICU {PLATFORM} --with-data-packaging=common`
4. Delete `data/out` folder and rebuild data: `cd data && rm -rf ./out && make`
5. Copy `source/data/out/icudt{ICU_VERSION}l.dat` to the `{JUNDOT_SOURCE}/thirdparty/icu4c/icudt_jundot.dat`
...
- `0001-big-files-support.patch` ([GH-100281](https://github.com/jundotengine/jundot/pull/100281))
...
- `0001-cmake-generated-headers.patch` ([GH-104347](https://github.com/jundotengine/jundot/pull/104347))
  * Compare with CMake-generated headers to bump version and added potential new config values.
- `0002-disable-16bitlossless.patch` ([GH-104347](https://github.com/jundotengine/jundot/pull/104347))
- `0003-remove-bmp-ppm-support.patch` ([GH-104347](https://github.com/jundotengine/jundot/pull/104347))
...
- `0001-external-basisu.patch` ([GH-76572](https://github.com/jundotengine/jundot/pull/76572))
- `0002-disable-astc-block-ext.patch` ([GH-76572](https://github.com/jundotengine/jundot/pull/76572))
- `0003-basisu-1.60.patch` ([GH-103968](https://github.com/jundotengine/jundot/pull/103968))
...
- `0001-msvc-node-debug-rename.patch` ([GH-75769](https://github.com/jundotengine/jundot/pull/75769))
- `0002-msvc-arm64-fpstrict.patch` ([GH-94655](https://github.com/jundotengine/jundot/pull/94655))
- `0003-clang-cl-sse2-sse41-avx2.patch` ([GH-92316](https://github.com/jundotengine/jundot/pull/92316))
...
- Added 2 files `jundot_core_mbedtls_platform.c` and `jundot_core_mbedtls_config.h`
  providing configuration for light bundling with core
- Added 2 files `jundot_module_mbedtls_config.h` and `threading_alt.h`
  to customize the build configuration when bundling the full library

Patches:

- `0001-msvc-2019-psa-redeclaration.patch` ([GH-90535](https://github.com/jundotengine/jundot/pull/90535))
...
- `0001-disable-exceptions.patch` ([GH-85039](https://github.com/jundotengine/jundot/pull/85039))
- `0002-clang-std-replacements-leak.patch` ([GH-85208](https://github.com/jundotengine/jundot/pull/85208))
- `0003-explicit-includes.patch` ([GH-111557](https://github.com/jundotengine/jundot/pull/111557))
...
- `LICENSE`
- `src/miniupnpcstrings.h` was created manually for Jundot (it is usually generated
...
- `0001-jundot-seek.patch` ([GH-10428](https://github.com/jundotengine/jundot/pull/10428))


## misc

Collection of single-file libraries used in Jundot components.
...
- `FastNoiseLite.h`
  ...
  * License: MIT
  * Patches:
    - `FastNoiseLite-0001-namespace-warnings.patch` ([GH-88526](https://github.com/jundotengine/jundot/pull/88526))
- `ifaddrs-android.{cc,h}`
  * Upstream: https://chromium.googlesource.com/external/webrtc/stable/talk/+/master/base/ifaddrs-android.h
  * Version: git (5976650443d68ccfadf1dea24999ee459dd2819d, 2013)
  * License: BSD-3-Clause
  * Patches:
    - `ifaddrs-android-0001-complete-struct.patch` ([GH-34101](https://github.com/jundotengine/jundot/pull/34101))
- `mikktspace.{c,h}`
...
- `polypartition.{cpp,h}`
  ...
  * License: MIT
  * Patches:
    - `polypartition-0001-jundot-types.patch` (2185c018f)
    - `polypartition-0002-shadow-warning.patch` ([GH-66808](https://github.com/jundotengine/jundot/pull/66808))
- `qoa.{c,h}`
...
- `smaz.{c,h}`
  ...
  * Modifications: License included in header.
  * Patches:
    - `smaz-0001-write-string-warning.patch` ([GH-8572](https://github.com/jundotengine/jundot/pull/8572))
- `smolv.{cpp,h}`
...
- `0001-remove-unused-save-features.patch` ([GH-113965](https://github.com/jundotengine/jundot/issues/113965))
...
Important: Nearly all files have Jundot-made changes and renames
...
proposed by these libraries and better integrate them with Jundot.
...
- `0001-remove-unnecessary-subsystems.patch` ([GH-106218](https://github.com/jundotengine/jundot/pull/106218))
- `0003-std-include.patch` ([GH-108144](https://github.com/jundotengine/jundot/pull/108144))
- `0004-errno-include.patch` ([GH-108354](https://github.com/jundotengine/jundot/pull/108354))
- `0005-fix-libudev-dbus.patch` ([GH-108373](https://github.com/jundotengine/jundot/pull/108373))
- `0006-fix-cs-environ.patch` ([GH-109283](https://github.com/jundotengine/jundot/pull/109283))
- `0007-shield-duplicate-macos.patch` ([GH-115510](https://github.com/jundotengine/jundot/pull/115510))
- `0008-fix-linux-joycon-serial-num.patch` ([GH-113873](https://github.com/jundotengine/jundot/pull/113873))
- `0009-update-device-blocklist.patch` ([GH-119403](https://github.com/jundotengine/jundot/pull/119403))
...
- `0001-zero-size-for-sc-sized-arrays.patch` ([GH-94985](https://github.com/jundotengine/jundot/pull/94985))
- `0002-spirv-headers.patch` ([GH-111452](https://github.com/jundotengine/jundot/pull/111452))


## swappy-frame-pacing

- Upstream: https://android.googlesource.com/platform/frameworks/opt/gamesdk/ via https://github.com/jundotengine/jundot-swappy
...
- `0001-let-delete-be-delete.patch` ([GH-116024](https://github.com/jundotengine/jundot/pull/116024))
...
- `0001-external-zlib.patch` ([GH-55115](https://github.com/jundotengine/jundot/pull/55115))
...
- `0001-bullet-namespace.patch` ([GH-27929](https://github.com/jundotengine/jundot/pull/27929))
- `0002-fpermissive-fix.patch` ([GH-27929](https://github.com/jundotengine/jundot/pull/27929))
- `0003-fix-musl-build.patch` ([GH-34250](https://github.com/jundotengine/jundot/pull/34250))
- `0004-fix-msvc-arm-build.patch` ([GH-34331](https://github.com/jundotengine/jundot/pull/34331))
- `0005-fix-scale-calculation.patch` ([GH-38506](https://github.com/jundotengine/jundot/pull/38506))
- `0006-gcc13-include-fix.patch` ([GH-77949](https://github.com/jundotengine/jundot/pull/77949))
...
`vk_mem_alloc.cpp` is a Jundot file and should be preserved on updates.

Patches:

- `0001-VKEnumStringHelper-jundot-vulkan.patch` ([GH-97510](https://github.com/jundotengine/jundot/pull/97510))
- `0002-VMA-jundot-vulkan.patch` ([GH-97510](https://github.com/jundotengine/jundot/pull/97510))
- `0003-VMA-add-vmaCalculateLazilyAllocatedBytes.patch` ([GH-99257](https://github.com/jundotengine/jundot/pull/99257))
...
- Run `cmake .` to generate `config.h` and `wslayver.h`
  Contents might need tweaking for Jundot, review diff
...
- `0001-msvc-build-fix.patch` ([GH-30263](https://github.com/jundotengine/jundot/pull/30263))
