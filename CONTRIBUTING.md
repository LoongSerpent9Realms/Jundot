...
contributing to Jundot, especially via bug reports or pull requests.

Jundot has a dedicated [Contributing documentation](https://contributing.jundotengine.org/en/latest/organization/how_to_contribute.html)
...
- [Contributing to Jundot translations](#contributing-to-jundot-translations)
- [Communicating with developers](#communicating-with-developers)

## Reporting bugs

Report bugs [here](https://github.com/jundotengine/jundot/issues/new?assignees=&labels=&template=bug_report.yml).
Please follow the instructions in the template when you do.

Notably, please include a Minimal Reproduction Project (MRP), which is a small
Jundot project which reproduces the issue, with no unnecessary files included.
Be sure to not include the `.jundot` folder in the archive to save space.

Make sure that the bug you are experiencing is reproducible in the latest Jundot
releases. You can find an overview of all Jundot releases [on the website](https://jundotengine.org/download/archive/)
...
If you run into a bug which wasn't present in an earlier Jundot version (what we
...
Instead, head to the [Jundot Proposals repository](https://github.com/jundotengine/jundot-proposals)
...
You can refer to the [Pull request review process](https://contributing.jundotengine.org/en/latest/organization/pull_requests/review_guidelines.html)
...
[Engine development guide](https://docs.jundotengine.org/en/latest/engine_details/development/index.html)
for an introduction to developing on Jundot.

The [Contributing docs](https://contributing.jundotengine.org/en/latest/organization/how_to_contribute.html)
also have important information on the [PR workflow](https://contributing.jundotengine.org/en/latest/organization/pull_requests/creating_pull_requests.html)
(with a helpful guide for Git usage), and our [Code style guidelines](https://contributing.jundotengine.org/en/latest/engine/guidelines/cpp_usage_guidelines.html)
...
See our [PR workflow](https://contributing.jundotengine.org/en/latest/organization/pull_requests/creating_pull_requests.html)
...
When using the French fries frying module, Jundot would not regulate the heat
and thus bring the oil bath to supercritical liquid conditions, thus causing
unwanted side effects in the physics engine.

By fixing the regulation system via an added binding to the internal feature,
this commit now ensures that Jundot will not go past the ebullition temperature
...
[Update documentation XML files](https://contributing.jundotengine.org/en/latest/documentation/class_reference.html)
using your compiled binary, then fill in the descriptions.
Follow the style guide described in the
[Documentation writing guidelines](https://contributing.jundotengine.org/en/latest/documentation/guidelines/docs_writing_guidelines.html).
...
See [Unit testing](https://contributing.jundotengine.org/en/latest/engine/unit_tests.html)
for information on writing tests in Jundot's C++ codebase.

## Contributing to Jundot translations

You can contribute to Jundot translations on [Hosted Weblate](https://hosted.weblate.org/projects/jundot-engine/),
an open source and web-based translation platform.

Please refer to our [editor and documentation localization guidelines](https://contributing.jundotengine.org/en/latest/documentation/translation/index.html)
for an overview of the translation resources and what they correspond to.

## Communicating with developers

The Jundot Engine community has [many communication
channels](https://jundotengine.org/community), some used more for user-level
discussions and support, others more for development discussions.

To communicate with developers (e.g. to discuss a feature you want to implement
or a bug you want to fix), the following channels can be used:

- [Jundot Contributors Chat](https://chat.jundotengine.org): You will
  find most core developers there, so it's the go-to platform for direct chat
  about Jundot Engine development. Browse the [Directory](https://chat.jundotengine.org/directory/channels)
  for an overview of public channels focusing on various engine areas which you
  might be interested in.
- [Bug tracker](https://github.com/jundotengine/jundot/issues): If there is an
  existing issue about a topic you want to discuss, you can participate directly.
  If not, you can open a new issue. Please mind the guidelines outlined above
  for bug reporting.
- [Feature proposals](https://github.com/jundotengine/jundot-proposals/issues):
  To propose a new feature, we have a dedicated issue tracker for that. Don't
  hesitate to start by talking about your idea on the Jundot Contributors Chat
  to make sure that it makes sense in Jundot's context.

Thanks for your interest in contributing!

—The Jundot development team
