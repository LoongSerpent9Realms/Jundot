...
{
    /// <inheritdoc cref="CreateAction(string, UndoRedo.MergeMode, JundotObject, bool)"/>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public void CreateAction(string name, UndoRedo.MergeMode mergeMode, JundotObject customContext)
    {
