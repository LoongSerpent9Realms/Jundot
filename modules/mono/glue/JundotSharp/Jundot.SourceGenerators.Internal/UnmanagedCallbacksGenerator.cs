...
namespace Jundot.SourceGenerators.Internal;
        ...
        foreach (var callback in data.Methods)
        {
            ...
            for (int i = 0; i < callback.Parameters.Length; i++)
            {
                ...
                if (parameter.RefKind == RefKind.Out)
                {
                    ...
                    if (IsJundotInteropStruct(parameter.Type))
...
");
        ...
        foreach (var callback in data.Methods)
        {
            ...
            foreach (var parameter in callback.Parameters)
            {
                if (IsByRefParameter(parameter))
                {
                    if (IsJundotInteropStruct(parameter.Type) || parameter.Type.IsValueType)
                    {
    ...
    private static bool IsJundotInteropStruct(ITypeSymbol type) =>
        _jundotInteropStructs.Contains(type.FullQualifiedNameOmitGlobal());
    ...
    private static readonly string[] _jundotInteropStructs =
    {
        "Jundot.NativeInterop.jundot_ref",
        "Jundot.NativeInterop.jundot_variant_call_error",
        "Jundot.NativeInterop.jundot_variant",
        "Jundot.NativeInterop.jundot_string",
        "Jundot.NativeInterop.jundot_string_name",
        "Jundot.NativeInterop.jundot_node_path",
        "Jundot.NativeInterop.jundot_signal",
        "Jundot.NativeInterop.jundot_callable",
        "Jundot.NativeInterop.jundot_array",
        "Jundot.NativeInterop.jundot_dictionary",
        "Jundot.NativeInterop.jundot_packed_byte_array",
        "Jundot.NativeInterop.jundot_packed_int32_array",
        "Jundot.NativeInterop.jundot_packed_int64_array",
        "Jundot.NativeInterop.jundot_packed_float32_array",
        "Jundot.NativeInterop.jundot_packed_float64_array",
        "Jundot.NativeInterop.jundot_packed_string_array",
        "Jundot.NativeInterop.jundot_packed_vector2_array",
        "Jundot.NativeInterop.jundot_packed_vector3_array",
        "Jundot.NativeInterop.jundot_packed_vector4_array",
        "Jundot.NativeInterop.jundot_packed_color_array",
    };
}
