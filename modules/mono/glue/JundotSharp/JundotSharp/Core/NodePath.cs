...
namespace Jundot
{
    ...
    {
        internal jundot_node_path.movable NativeValue;
        ...
        private NodePath(jundot_node_path nativeValueToOwn)
        {
            NativeValue = (jundot_node_path.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static NodePath CreateTakingOwnershipOfDisposableValue(jundot_node_path nativeValueToOwn)
        ...
        public NodePath(string path)
        {
            ...
            {
                NativeValue = (jundot_node_path.movable)NativeFuncs.jundotsharp_node_path_new_from_string(path);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (jundot_node_path)NativeValue;
            NativeFuncs.jundotsharp_node_path_as_string(out jundot_string dest, src);
            using (dest)
        ...
        {
            jundot_node_path propertyPath = default;
            var self = (jundot_node_path)NativeValue;
            NativeFuncs.jundotsharp_node_path_get_as_property_path(self, ref propertyPath);
        ...
        {
            var self = (jundot_node_path)NativeValue;
            NativeFuncs.jundotsharp_node_path_get_concatenated_names(self, out jundot_string names);
            using (names)
        ...
        {
            var self = (jundot_node_path)NativeValue;
            NativeFuncs.jundotsharp_node_path_get_concatenated_subnames(self, out jundot_string subNames);
            using (subNames)
        ...
        {
            var self = (jundot_node_path)NativeValue;
            NativeFuncs.jundotsharp_node_path_get_name(self, idx, out jundot_string name);
            using (name)
        ...
        {
            var self = (jundot_node_path)NativeValue;
            return NativeFuncs.jundotsharp_node_path_get_name_count(self);
        }
        ...
        {
            var self = (jundot_node_path)NativeValue;
            NativeFuncs.jundotsharp_node_path_get_subname(self, idx, out jundot_string subName);
            using (subName)
        ...
        {
            var self = (jundot_node_path)NativeValue;
            return NativeFuncs.jundotsharp_node_path_get_subname_count(self);
        }
        ...
        {
            var self = (jundot_node_path)NativeValue;
            return NativeFuncs.jundotsharp_node_path_is_absolute(self).ToBool();
        }
        ...
        public bool Equals([NotNullWhen(true)] NodePath? other)
        {
            if (other is null)
                return false;
            var self = (jundot_node_path)NativeValue;
            var otherNative = (jundot_node_path)other.NativeValue;
            return NativeFuncs.jundotsharp_node_path_equals(self, otherNative).ToBool();
        }
        ...
        {
            var self = (jundot_node_path)NativeValue;
            return NativeFuncs.jundotsharp_node_path_hash(self);
        }
    }
}
