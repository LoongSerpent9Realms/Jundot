...
namespace Jundot.Collections
{
    /// <summary>
    /// Wrapper around Jundot's Array class, an array of Variant
...
#pragma warning restore CA1710
        ...
        IDisposable
    {
        internal jundot_array.movable NativeValue;
        ...
        public Array()
        {
            NativeValue = (jundot_array.movable)NativeFuncs.jundotsharp_array_new();
        ...
        /// <returns>A new Jundot Array.</returns>
        ...
        /// </exception>
        /// <returns>A new Jundot Array.</returns>
        public Array(scoped ReadOnlySpan<JundotObject> span)
        {
            NativeValue = (jundot_array.movable)NativeFuncs.jundotsharp_array_new();
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        ...
        private Array(jundot_array nativeValueToOwn)
        {
            NativeValue = (jundot_array.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.jundotsharp_array_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Array CreateTakingOwnershipOfDisposableValue(jundot_array nativeValueToOwn)
        ...
        /// referenced in the source array. Note that any <see cref="JundotObject"/> derived
        ...
        {
            jundot_array newArray;
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_duplicate(ref self, deep.ToJundotBool(), out newArray);
        ...
        /// Note: If <paramref name="value"/> is of a reference type (<see cref="JundotObject"/>
        ...
        /// <example>
        /// <code>
        /// var array = new Jundot.Collections.Array();
        /// array.Resize(10);
        ...
        public void Fill(Variant value)
        {
            ...
            jundot_variant variantValue = (jundot_variant)value.NativeVar;
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_fill(ref self, variantValue);
        }
        ...
        public Variant Max()
        {
            jundot_variant resVariant;
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_max(ref self, out resVariant);
        ...
        public Variant Min()
        {
            jundot_variant resVariant;
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_min(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Jundot.Collections.Array { 1, 2, 3, 4 };
        ...
        public Variant PickRandom()
        {
            jundot_variant resVariant;
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_pick_random(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        {
            var self = (jundot_array)NativeValue;
            var otherVariant = (jundot_array)other.NativeValue;
            return NativeFuncs.jundotsharp_array_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public Error Resize(int newSize)
        {
            ...
            var self = (jundot_array)NativeValue;
            return NativeFuncs.jundotsharp_array_resize(ref self, newSize);
        }
        ...
        public void Reverse()
        {
            ...
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_reverse(ref self);
        }
        ...
        public void Shuffle()
        {
            ...
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_shuffle(ref self);
        }
        ...
        public Array GetSliceRange(int start, int end, int step = 1, bool deep = false)
        {
            jundot_array newArray;
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_slice(ref self, start, end, step, deep.ToJundotBool(), out newArray);
            return CreateTakingOwnershipOfDisposableValue(newArray);
        }
        ...
        /// <example>
        /// <code>
        /// var strings = new Jundot.Collections.Array { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        ...
        public void Sort()
        {
            ...
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_sort(ref self);
        }
        ...
        /// <returns>A new Jundot Array with the contents of both arrays.</returns>
        ...
        public unsafe Variant this[int index]
        {
            get
            {
                GetVariantBorrowElementAt(index, out jundot_variant borrowElem);
            ...
            set
            {
                ...
                var self = (jundot_array)NativeValue;
                jundot_variant* ptrw = NativeFuncs.jundotsharp_array_ptrw(ref self);
                jundot_variant* itemPtr = &ptrw[index];
                (*itemPtr).Dispose();
        ...
        public void Add(Variant item)
        {
            ...
            jundot_variant variantValue = (jundot_variant)item.NativeVar;
            var self = (jundot_array)NativeValue;
            _ = NativeFuncs.jundotsharp_array_add(ref self, variantValue);
        }
        ...
        public void AddRange<[MustBeVariant] T>(IEnumerable<T> collection)
        {
            ...
            // If the collection is another Jundot Array, we can add the items
            // with a single interop call.
            if (collection is Array array)
            {
                var self = (jundot_array)NativeValue;
                var collectionNative = (jundot_array)array.NativeValue;
                _ = NativeFuncs.jundotsharp_array_add_range(ref self, collectionNative);
                return;
            }
            if (collection is Array<T> typedArray)
            {
                var self = (jundot_array)NativeValue;
                var collectionNative = (jundot_array)typedArray.NativeValue;
                _ = NativeFuncs.jundotsharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        public int BinarySearch(int index, int count, Variant item)
        {
            ...
            jundot_variant variantValue = (jundot_variant)item.NativeVar;
            var self = (jundot_array)NativeValue;
            return NativeFuncs.jundotsharp_array_binary_search(ref self, index, count, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var arr = new Jundot.Collections.Array { "inside", 7 };
        ...
        public int IndexOf(Variant item)
        {
            ...
            jundot_variant variantValue = (jundot_variant)item.NativeVar;
            var self = (jundot_array)NativeValue;
            return NativeFuncs.jundotsharp_array_index_of(ref self, variantValue);
        }
        ...
        public int IndexOf(Variant item, int index)
        {
            ...
            jundot_variant variantValue = (jundot_variant)item.NativeVar;
            var self = (jundot_array)NativeValue;
            return NativeFuncs.jundotsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public int LastIndexOf(Variant item)
        {
            ...
            jundot_variant variantValue = (jundot_variant)item.NativeVar;
            var self = (jundot_array)NativeValue;
            return NativeFuncs.jundotsharp_array_last_index_of(ref self, variantValue, Count - 1);
        }
        ...
        public int LastIndexOf(Variant item, int index)
        {
            ...
            jundot_variant variantValue = (jundot_variant)item.NativeVar;
            var self = (jundot_array)NativeValue;
            return NativeFuncs.jundotsharp_array_last_index_of(ref self, variantValue, index);
        }
        ...
        public void Insert(int index, Variant item)
        {
            ...
            jundot_variant variantValue = (jundot_variant)item.NativeVar;
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_insert(ref self, index, variantValue);
        }
        ...
        public void RemoveAt(int index)
        {
            ...
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_remove_at(ref self, index);
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_make_read_only(ref self);
        }
        ...
        {
            var self = (jundot_array)NativeValue;
            NativeFuncs.jundotsharp_array_to_string(ref self, out jundot_string str);
            using (str)
        ...
        /// <paramref name="index"/> is less than 0 or greater than the array's size.
        /// </exception>
        internal void GetVariantBorrowElementAt(int index, out jundot_variant elem)
        {
            if (index < 0 || index >= Count)
                throw new ArgumentOutOfRangeException(nameof(index));
        ...
        /// The variant returned via the <paramref name="elem"/> parameter is owned by the Array and must not be disposed.
        /// </summary>
        internal unsafe void GetVariantBorrowElementAtUnchecked(int index, out jundot_variant elem)
        {
    ...
    internal interface IGenericJundotArray
    {
        public Array UnderlyingArray { get; }
    }

    /// <summary>
    /// Typed wrapper around Jundot's Array class, an array of <typeparamref name="T"/>
    ...
    public sealed class Array<[MustBeVariant] T> :
        ...
        IGenericJundotArray
    {
        private static jundot_variant ToVariantFunc(scoped in Array<T> jundotArray) =>
            VariantUtils.CreateFromArray(jundotArray);

        private static Array<T> FromVariantFunc(in jundot_variant variant) =>
        ...
        private void SetTypedForUnderlyingArray()
        {
            ...
            using (elemScriptRef)
            {
                NativeFuncs.jundotsharp_array_set_typed(
                    ref self,
        ...
        Array IGenericJundotArray.UnderlyingArray => _underlyingArray;

        internal ref jundot_array.movable NativeValue
        {
        ...
        // Explicit name to make it very clear
        internal static Array<T> CreateTakingOwnershipOfDisposableValue(jundot_array nativeValueToOwn)
        ...
        /// <returns>A new Jundot Array, or <see langword="null"/> if <see paramref="from"/> was null.</returns>
        ...
        /// <example>
        /// <code>
        /// var array = new Jundot.Collections.Array&lt;int&gt;();
        /// array.Resize(10);
        /// array.Fill(0); // Initialize the 10 elements to 0.
        /// </code>
        /// </example>
        ...
        public void Fill(T value)
        {
            ...
            jundot_variant variantValue = VariantUtils.CreateFrom(value);
            var self = (jundot_array)_underlyingArray.NativeValue;
            NativeFuncs.jundotsharp_array_fill(ref self, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Jundot.Collections.Array&lt;int&gt; { 1, 2, 3, 4 };
        /// GD.Print(array.PickRandom()); // Prints either of the four numbers.
        /// </code>
        /// </example>
        /// <returns>A random element from the array.</returns>
        ...
        /// <example>
        /// <code>
        /// var strings = new Jundot.Collections.Array&lt;string&gt; { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        /// GD.Print(strings); // Prints [string1, string10, string11, string2]
        /// </code>
        /// </example>
        ...
        public unsafe T this[int index]
        {
            get
            {
                _underlyingArray.GetVariantBorrowElementAt(index, out jundot_variant borrowElem);
        ...
        public int IndexOf(T item, int index)
        {
            ...
            jundot_variant variantValue = VariantUtils.CreateFrom(item);
            var self = (jundot_array)_underlyingArray.NativeValue;
            return NativeFuncs.jundotsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public void AddRange(IEnumerable<T> collection)
        {
            ...
            {
                var self = (jundot_array)_underlyingArray.NativeValue;
                var collectionNative = (jundot_array)typedArray._underlyingArray.NativeValue;
                _ = NativeFuncs.jundotsharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        /// <example>
        /// <code>
        /// var arr = new Jundot.Collections.Array&lt;string&gt; { "inside", "7" };
        /// GD.Print(arr.Contains("inside")); // True
        /// GD.Print(arr.Contains("outside")); // False
        /// GD.Print(arr.Contains(7)); // False
        /// GD.Print(arr.Contains("7")); // True
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Array<T>(Variant from) => from.AsJundotArray<T>();
