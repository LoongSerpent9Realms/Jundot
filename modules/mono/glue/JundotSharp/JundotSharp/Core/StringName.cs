...
namespace Jundot
{
    ...
    {
        internal jundot_string_name.movable NativeValue;
        ...
        private StringName(jundot_string_name nativeValueToOwn)
        {
            NativeValue = (jundot_string_name.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static StringName CreateTakingOwnershipOfDisposableValue(jundot_string_name nativeValueToOwn)
        ...
        public StringName(string name)
        {
            ...
            {
                NativeValue = (jundot_string_name.movable)NativeFuncs.jundotsharp_string_name_new_from_string(name);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (jundot_string_name)NativeValue;
            NativeFuncs.jundotsharp_string_name_as_string(out jundot_string dest, src);
            using (dest)
        ...
        public static bool operator ==(StringName? left, in jundot_string_name right)
        {
            if (left is null)
        ...
        public static bool operator ==(in jundot_string_name left, StringName? right)
        {
            return right == left;
        }
        ...
        public bool Equals(in jundot_string_name other)
        {
