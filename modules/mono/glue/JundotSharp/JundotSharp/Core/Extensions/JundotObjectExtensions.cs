...
namespace Jundot
{
    public partial class JundotObject
    {
        /// <summary>
        /// Returns the <see cref="JundotObject"/> that corresponds to <paramref name="instanceId"/>.
        ...
        /// <returns>The <see cref="JundotObject"/> instance.</returns>
        public static JundotObject? InstanceFromId(ulong instanceId)
        {
            return InteropUtils.UnmanagedGetManaged(NativeFuncs.jundotsharp_instance_from_id(instanceId));
        }

        /// <summary>
        /// Returns <see langword="true"/> if the <see cref="JundotObject"/> that corresponds
        ...
        /// valid <see cref="JundotObject"/> (e.g. has not been deleted from memory).
        /// </summary>
        /// <param name="instance">The instance to check.</param>
        /// <returns>If the instance is a valid object.</returns>
        public static bool IsInstanceValid([NotNullWhen(true)] JundotObject? instance)
        {
        ...
        /// <returns>
        /// The <see cref="Jundot.WeakRef"/> reference to the object or <see langword="null"/>.
        /// </returns>
        public static WeakRef? WeakRef(JundotObject? obj)
        {
            if (!IsInstanceValid(obj))
                return null;

            NativeFuncs.jundotsharp_weakref(GetPtr(obj), out jundot_ref weakRef);
            using (weakRef)
            {
                if (weakRef.IsNull)
                    return null;
