...
namespace Jundot
{
    public partial class JundotObject : IDisposable
    {
        private bool _disposed;
        private static readonly Type _cachedType = typeof(JundotObject);
        ...
        private WeakReference<JundotObject>? _weakReferenceToSelf;

        /// <summary>
        /// Constructs a new <see cref="JundotObject"/>.
        /// </summary>
        public JundotObject() : this(false)
        {
            unsafe
            {
        ...
        internal JundotObject(IntPtr nativePtr) : this(false)
        {
        ...
        internal unsafe void ConstructAndInitialize(
            delegate* unmanaged<jundot_bool, IntPtr> nativeCtor,
        ...
        )
        {
            if (NativePtr == IntPtr.Zero)
            {
                ...
                NativePtr = nativeCtor(jundot_bool.True);
            ...
            _weakReferenceToSelf = DisposablesTracker.RegisterJundotObject(this);
        }

        internal JundotObject(bool memoryOwn)
        {
            _memoryOwn = memoryOwn;
        }

        /// <summary>
        /// The pointer to the native instance of this <see cref="JundotObject"/>.
        /// </summary>
        public IntPtr NativeInstance => NativePtr;

        internal static IntPtr GetPtr(JundotObject? instance)
        {
            if (instance == null)
                return IntPtr.Zero;
        ...
        /// <summary>
        /// Disposes of this <see cref="JundotObject"/>.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// Disposes implementation of this <see cref="JundotObject"/>.
        /// </summary>
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (NativePtr != IntPtr.Zero)
            {
                IntPtr gcHandleToFree = NativeFuncs.jundotsharp_internal_object_get_associated_gchandle(NativePtr);
                ...
                if (_memoryOwn)
                {
                    NativeFuncs.jundotsharp_internal_refcounted_disposed(NativePtr, gcHandleToFree,
                        (!disposing).ToJundotBool());
                }
                else
                {
                    NativeFuncs.jundotsharp_internal_object_disposed(NativePtr, gcHandleToFree);
                }
            ...
            {
                DisposablesTracker.UnregisterJundotObject(this, _weakReferenceToSelf);
            }
        }

        /// <summary>
        /// Converts this <see cref="JundotObject"/> to a string.
        /// </summary>
        /// <returns>A string representation of this object.</returns>
        public override string ToString()
        {
            NativeFuncs.jundotsharp_object_to_string(GetPtr(this), out jundot_string str);
            using (str)
        ...
        /// </returns>
        public SignalAwaiter ToSignal(JundotObject source, StringName signal)
        {
        ...
        {
            if (ReferenceEquals(t.Assembly, typeof(JundotObject).Assembly))
            {
                return true;
            }
            ...
            {
                return t.Assembly.GetName().Name == "JundotSharpEditor";
            }
        ...
        internal static Type InternalGetClassNativeBase(Type t)
        {
            ...
            {
                Debug.Assert(t.BaseType is not null, "Script types must derive from a native Jundot type.");
        ...
        /// This method is used by Jundot to assign property values.
        ...
        protected internal virtual bool SetJundotClassPropertyValue(in jundot_string_name name, in jundot_variant value)
        {
            return false;
        }
        ...
        /// This method is used by Jundot to retrieve property values.
        /// Do not call or override this method.
        /// </summary>
        ...
        /// <returns><see langword="true"/> if a property with the given name was found.</returns>
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual bool GetJundotClassPropertyValue(in jundot_string_name name, out jundot_variant value)
        {
            value = default;
            return false;
        }
        ...
        /// This method is used by Jundot to raise signals from the engine side.\n"
        /// Do not call or override this method.
        /// </summary>
        /// <param name="signal">Name of the signal to raise.</param>
        /// <param name="args">Arguments to use with the raised signal.</param>
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void RaiseJundotClassSignalCallbacks(in jundot_string_name signal,
        ...
        {
            var typeSelf = (jundot_string_name)type.NativeValue;
            var methodSelf = (jundot_string_name)method.NativeValue;
            IntPtr methodBind = NativeFuncs.jundotsharp_method_bind_get_method(typeSelf, methodSelf);
        ...
        internal static IntPtr ClassDB_get_method_with_compatibility(StringName type, StringName method, ulong hash)
        {
            var typeSelf = (jundot_string_name)type.NativeValue;
            var methodSelf = (jundot_string_name)method.NativeValue;
            IntPtr methodBind = NativeFuncs.jundotsharp_method_bind_get_method_with_compatibility(typeSelf, methodSelf, hash);
        ...
        internal static unsafe delegate* unmanaged<jundot_bool, IntPtr> ClassDB_get_constructor(StringName type)
        {
            // for some reason the '??' operator doesn't support 'delegate*'
            var typeSelf = (jundot_string_name)type.NativeValue;
            var nativeConstructor = NativeFuncs.jundotsharp_get_class_constructor(typeSelf);
        ...
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void SaveJundotObjectData(JundotSerializationInfo info)
        {
        }
        ...
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void RestoreJundotObjectData(JundotSerializationInfo info)
        {
        }
    }
}
