...
namespace Jundot
{
    internal static class DelegateUtils
    {
        ...
        internal static jundot_bool DelegateEquals(IntPtr delegateGCHandleA, IntPtr delegateGCHandleB)
        {
            try
            {
                ...
                return (@delegateA! == @delegateB!).ToJundotBool();
            }
            catch (Exception e)
            {
        ...
        [UnmanagedCallersOnly]
        internal static unsafe int GetArgumentCount(IntPtr delegateGCHandle, jundot_bool* outIsValid)
        {
            try
            {
                var @delegate = (Delegate?)GCHandle.FromIntPtr(delegateGCHandle).Target;
                ...
                if (argCount is null)
                {
                    *outIsValid = jundot_bool.False;
                    return 0;
                }
                *outIsValid = jundot_bool.True;
        ...
        internal static unsafe void InvokeWithVariantArgs(IntPtr delegateGCHandle, void* trampoline,
            jundot_variant** args, int argc, jundot_variant* outRet)
        {
            try
            {
                if (trampoline == null)
                ...
                var @delegate = (Delegate)GCHandle.FromIntPtr(delegateGCHandle).Target!;
                var trampolineFn = (delegate* managed<object, NativeVariantPtrArgs, out jundot_variant, void>)trampoline;

                trampolineFn(@delegate, new NativeVariantPtrArgs(args, argc), out jundot_variant ret);
        ...
        private static bool TrySerializeSingleDelegate(Delegate @delegate, [MaybeNullWhen(false)] out byte[] buffer)
        {
            ...
            switch (target)
            {
                ...
                case JundotObject jundotObject:
                {
                    if (!JundotObject.IsInstanceValid(jundotObject))
                    {
                    ...
                    using (var writer = new BinaryWriter(stream))
                    {
                        writer.Write((ulong)TargetKind.JundotObject);
                        // ReSharper disable once RedundantCast
                        writer.Write((ulong)jundotObject.GetInstanceId());
                    ...
                    if (targetType.IsDefined(typeof(CompilerGeneratedAttribute), true))
                    {
                        ...
                        using (var writer = new BinaryWriter(stream))
                        {
                            ...
                            foreach (FieldInfo field in fields)
                            {
                                ...
                                static byte[] VarToBytes(in jundot_variant var)
                                {
                                    NativeFuncs.jundotsharp_var_to_bytes(var, jundot_bool.True, out var varBytes);
                                    using (varBytes)
        ...
        [UnmanagedCallersOnly]
        internal static unsafe jundot_bool TrySerializeDelegateWithGCHandle(IntPtr delegateGCHandle,
            jundot_array* nSerializedData)
        {
            try
            {
                var serializedData = Collections.Array.CreateTakingOwnershipOfDisposableValue(
                    NativeFuncs.jundotsharp_array_new_copy(*nSerializedData));
        ...
        [UnmanagedCallersOnly]
        internal static unsafe jundot_bool TryDeserializeDelegateWithGCHandle(jundot_array* nSerializedData,
        ...
        private static bool TryDeserializeSingleDelegate(byte[] buffer, [MaybeNullWhen(false)] out Delegate @delegate)
        {
            ...
            using (var reader = new BinaryReader(stream))
            {
                ...
                switch (targetKind)
                {
                    ...
                    case TargetKind.JundotObject:
                    {
                        ulong objectId = reader.ReadUInt64();
                        JundotObject? jundotObject = JundotObject.InstanceFromId(objectId);
                        ...
                        @delegate = Delegate.CreateDelegate(delegateType, jundotObject, methodInfo,
                        ...
                        for (int i = 0; i < fieldCount; i++)
                        {
                            ...
                            if (fieldInfo != null)
                            {
                                ...
                                object? managedValue = RuntimeTypeConversionHelper.ConvertToObjectOfType(
                                    (jundot_variant)variantValue.NativeVar, fieldInfo.FieldType);
...
#pragma warning restore REFL045
        ...
        {
            public static jundot_variant ConvertToVariant(object? obj)
            {
                if (obj == null)
                    return default;
                ...
                switch (obj)
                {
                    ...
                    case JundotObject[] jundotObjectArray:
                        return VariantUtils.CreateFrom(jundotObjectArray);
                    ...
                    case Collections.Dictionary jundotDictionary:
                        return VariantUtils.CreateFrom(jundotDictionary);
                    case Collections.Array jundotArray:
                        return VariantUtils.CreateFrom(jundotArray);
                    case Variant variant:
                        return VariantUtils.CreateFrom(variant);
                    case JundotObject jundotObject:
                        return VariantUtils.CreateFrom(jundotObject);
                    case Enum @enum:
                        return VariantUtils.CreateFrom(Convert.ToInt64(@enum, CultureInfo.InvariantCulture));
                    case Collections.IGenericJundotDictionary jundotDictionary:
                        return VariantUtils.CreateFrom(jundotDictionary.UnderlyingDictionary);
                    case Collections.IGenericJundotArray jundotArray:
                        return VariantUtils.CreateFrom(jundotArray.UnderlyingArray);
                }
            ...
            private delegate object? ConvertToSystemObjectFunc(in jundot_variant managed);
            ...
            private static readonly System.Collections.Generic.Dictionary<Type, ConvertToSystemObjectFunc>
                ...
                {
                    [typeof(bool)] = (in jundot_variant variant) => VariantUtils.ConvertTo<bool>(variant),
                    [typeof(char)] = (in jundot_variant variant) => VariantUtils.ConvertTo<char>(variant),
                    [typeof(sbyte)] = (in jundot_variant variant) => VariantUtils.ConvertTo<sbyte>(variant),
                    [typeof(short)] = (in jundot_variant variant) => VariantUtils.ConvertTo<short>(variant),
                    [typeof(int)] = (in jundot_variant variant) => VariantUtils.ConvertTo<int>(variant),
                    [typeof(long)] = (in jundot_variant variant) => VariantUtils.ConvertTo<long>(variant),
                    [typeof(byte)] = (in jundot_variant variant) => VariantUtils.ConvertTo<byte>(variant),
                    [typeof(ushort)] = (in jundot_variant variant) => VariantUtils.ConvertTo<ushort>(variant),
                    [typeof(uint)] = (in jundot_variant variant) => VariantUtils.ConvertTo<uint>(variant),
                    [typeof(ulong)] = (in jundot_variant variant) => VariantUtils.ConvertTo<ulong>(variant),
                    [typeof(float)] = (in jundot_variant variant) => VariantUtils.ConvertTo<float>(variant),
                    [typeof(double)] = (in jundot_variant variant) => VariantUtils.ConvertTo<double>(variant),
                    [typeof(Vector2)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Vector2>(variant),
                    [typeof(Vector2I)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Vector2I>(variant),
                    [typeof(Rect2)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Rect2>(variant),
                    [typeof(Rect2I)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Rect2I>(variant),
                    [typeof(Transform2D)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Transform2D>(variant),
                    [typeof(Vector3)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Vector3>(variant),
                    [typeof(Vector3I)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Vector3I>(variant),
                    [typeof(Basis)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Basis>(variant),
                    [typeof(Quaternion)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Quaternion>(variant),
                    [typeof(Transform3D)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Transform3D>(variant),
                    [typeof(Vector4)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Vector4>(variant),
                    [typeof(Vector4I)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Vector4I>(variant),
                    [typeof(Aabb)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Aabb>(variant),
                    [typeof(Color)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Color>(variant),
                    [typeof(Plane)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Plane>(variant),
                    [typeof(Callable)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Callable>(variant),
                    [typeof(Signal)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Signal>(variant),
                    [typeof(string)] = (in jundot_variant variant) => VariantUtils.ConvertTo<string>(variant),
                    [typeof(byte[])] = (in jundot_variant variant) => VariantUtils.ConvertTo<byte[]>(variant),
                    [typeof(int[])] = (in jundot_variant variant) => VariantUtils.ConvertTo<int[]>(variant),
                    [typeof(long[])] = (in jundot_variant variant) => VariantUtils.ConvertTo<long[]>(variant),
                    [typeof(float[])] = (in jundot_variant variant) => VariantUtils.ConvertTo<float[]>(variant),
                    ...
                    [typeof(Color[])] = (in jundot_variant variant) => VariantUtils.ConvertTo<Color[]>(variant),
                    [typeof(StringName[])] =
                        (in jundot_variant variant) => VariantUtils.ConvertTo<StringName[]>(variant),
                    [typeof(NodePath[])] = (in jundot_variant variant) => VariantUtils.ConvertTo<NodePath[]>(variant),
                    [typeof(Rid[])] = (in jundot_variant variant) => VariantUtils.ConvertTo<Rid[]>(variant),
                    [typeof(StringName)] = (in jundot_variant variant) => VariantUtils.ConvertTo<StringName>(variant),
                    [typeof(NodePath)] = (in jundot_variant variant) => VariantUtils.ConvertTo<NodePath>(variant),
                    [typeof(Rid)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Rid>(variant),
                    [typeof(Jundot.Collections.Dictionary)] = (in jundot_variant variant) =>
                        VariantUtils.ConvertTo<Jundot.Collections.Dictionary>(variant),
                    [typeof(Jundot.Collections.Array)] =
                        (in jundot_variant variant) => VariantUtils.ConvertTo<Jundot.Collections.Array>(variant),
                    [typeof(Variant)] = (in jundot_variant variant) => VariantUtils.ConvertTo<Variant>(variant),
                };

            public static object? ConvertToObjectOfType(in jundot_variant variant, Type type)
            {
                if (_toSystemObjectFuncByType.TryGetValue(type, out var func))
                    return func(variant);

                if (typeof(JundotObject).IsAssignableFrom(type))
                    return VariantUtils.ConvertTo<JundotObject>(variant);

                if (typeof(JundotObject[]).IsAssignableFrom(type))
                {
                    static JundotObject[] ConvertToSystemArrayOfJundotObject(in jundot_array nativeArray, Type type)
                    {
                        var array = Collections.Array.CreateTakingOwnershipOfDisposableValue(
                            NativeFuncs.jundotsharp_array_new_copy(nativeArray));

                        int length = array.Count;
                        var ret = (JundotObject[])Activator.CreateInstance(type, length)!;

                        for (int i = 0; i < length; i++)
                            ret[i] = array[i].AsJundotObject();

                        return ret;
                    }

                    using var jundotArray = NativeFuncs.jundotsharp_variant_as_array(variant);
                    return ConvertToSystemArrayOfJundotObject(jundotArray, type);
                }
                ...
                if (type.IsGenericType)
                {
                    ...
                    if (genericTypeDef == typeof(Jundot.Collections.Dictionary<,>))
                    {
                        var ctor = type.GetConstructor(new[] { typeof(Jundot.Collections.Dictionary) });
                    ...
                    if (genericTypeDef == typeof(Jundot.Collections.Array<>))
                    {
                        var ctor = type.GetConstructor(new[] { typeof(Jundot.Collections.Array) });
                        ...
                        return ctor.Invoke(new object?[]
                        {
                            VariantUtils.ConvertTo<Jundot.Collections.Array>(variant)
                        });
                    }
                }
