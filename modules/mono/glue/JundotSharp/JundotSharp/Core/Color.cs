...
namespace Jundot
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        public float OkHslH
        {
            readonly get
            {
                return NativeFuncs.jundotsharp_color_get_ok_hsl_h(this);
            }
            set
            {
        ...
        public float OkHslS
        {
            readonly get
            {
                return NativeFuncs.jundotsharp_color_get_ok_hsl_s(this);
            }
            set
            {
        ...
        public float OkHslL
        {
            readonly get
            {
                return NativeFuncs.jundotsharp_color_get_ok_hsl_l(this);
            }
            set
            {
        ...
        /// format (each byte represents a color channel).
        /// ARGB is more compatible with DirectX, but not used much in Jundot.
        /// </summary>
        ...
        /// format (each byte represents a color channel).
        /// RGBA is Jundot's default and recommended format.
        /// </summary>
        ...
        {
            return NativeFuncs.jundotsharp_color_from_ok_hsl(hue, saturation, lightness, alpha);
        }
