...
{
    /// <summary>
    /// Wrapper around Jundot's Dictionary class, a dictionary of Variant
    ...
    public sealed class Dictionary :
        ...
        IDisposable
    {
        internal jundot_dictionary.movable NativeValue;
        ...
        public Dictionary()
        {
            NativeValue = (jundot_dictionary.movable)NativeFuncs.jundotsharp_dictionary_new();
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        private Dictionary(jundot_dictionary nativeValueToOwn)
        {
            NativeValue = (jundot_dictionary.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.jundotsharp_dictionary_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Dictionary CreateTakingOwnershipOfDisposableValue(jundot_dictionary nativeValueToOwn)
        ...
        /// referenced in the source dictionary. Note that any <see cref="JundotObject"/> derived
        /// elements will be shallow copied regardless of the <paramref name="deep"/>
        /// setting.
        /// </summary>
        /// <param name="deep">If <see langword="true"/>, performs a deep copy.</param>
        /// <returns>A new Jundot Dictionary.</returns>
        public Dictionary Duplicate(bool deep = false)
        {
            jundot_dictionary newDictionary;
            var self = (jundot_dictionary)NativeValue;
            NativeFuncs.jundotsharp_dictionary_duplicate(ref self, deep.ToJundotBool(), out newDictionary);
        ...
        public void Merge(Dictionary dictionary, bool overwrite = false)
        {
            ...
            var self = (jundot_dictionary)NativeValue;
            var other = (jundot_dictionary)dictionary.NativeValue;
            NativeFuncs.jundotsharp_dictionary_merge(ref self, in other, overwrite.ToJundotBool());
        }
        ...
        {
            var self = (jundot_dictionary)NativeValue;
            var otherVariant = (jundot_dictionary)other.NativeValue;
            return NativeFuncs.jundotsharp_dictionary_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public ICollection<Variant> Keys
        {
            get
            {
                jundot_array keysArray;
                var self = (jundot_dictionary)NativeValue;
                NativeFuncs.jundotsharp_dictionary_keys(ref self, out keysArray);
        ...
        public ICollection<Variant> Values
        {
            get
            {
                jundot_array valuesArray;
                var self = (jundot_dictionary)NativeValue;
                NativeFuncs.jundotsharp_dictionary_values(ref self, out valuesArray);
        ...
        private (Array keys, Array values, int count) GetKeyValuePairs()
        {
            ...
            int count = NativeFuncs.jundotsharp_dictionary_count(ref self);
        ...
        public Variant this[Variant key]
        {
            get
            {
                ...
                if (NativeFuncs.jundotsharp_dictionary_try_get_value(ref self,
                        (jundot_variant)key.NativeVar, out jundot_variant value).ToBool())
                {
            ...
            set
            {
                ...
                var self = (jundot_dictionary)NativeValue;
                NativeFuncs.jundotsharp_dictionary_set_value(ref self,
                    (jundot_variant)key.NativeVar, (jundot_variant)value.NativeVar);
            }
        }
        ...
        public void Add(Variant key, Variant value)
        {
            ...
            var variantKey = (jundot_variant)key.NativeVar;
            var self = (jundot_dictionary)NativeValue;

            if (NativeFuncs.jundotsharp_dictionary_contains_key(ref self, variantKey).ToBool())
                throw new ArgumentException("An element with the same key already exists.", nameof(key));

            jundot_variant variantValue = (jundot_variant)value.NativeVar;
            NativeFuncs.jundotsharp_dictionary_add(ref self, variantKey, variantValue);
        }
        ...
        public void Clear()
        {
            ...
            var self = (jundot_dictionary)NativeValue;
            NativeFuncs.jundotsharp_dictionary_clear(ref self);
        }
        ...
        {
            var self = (jundot_dictionary)NativeValue;
            return NativeFuncs.jundotsharp_dictionary_contains_key(ref self, (jundot_variant)key.NativeVar).ToBool();
        }

        bool ICollection<KeyValuePair<Variant, Variant>>.Contains(KeyValuePair<Variant, Variant> item)
        {
            jundot_variant variantKey = (jundot_variant)item.Key.NativeVar;
            var self = (jundot_dictionary)NativeValue;
            bool found = NativeFuncs.jundotsharp_dictionary_try_get_value(ref self,
                variantKey, out jundot_variant retValue).ToBool();
            ...
            using (retValue)
            {
                ...
                jundot_variant variantValue = (jundot_variant)item.Value.NativeVar;
                return NativeFuncs.jundotsharp_variant_equals(variantValue, retValue).ToBool();
            }
        }
        ...
        public bool Remove(Variant key)
        {
            ...
            var self = (jundot_dictionary)NativeValue;
            return NativeFuncs.jundotsharp_dictionary_remove_key(ref self, (jundot_variant)key.NativeVar).ToBool();
        }
        ...
        bool ICollection<KeyValuePair<Variant, Variant>>.Remove(KeyValuePair<Variant, Variant> item)
        {
            ...
            using (retValue)
            {
                ...
                jundot_variant variantValue = (jundot_variant)item.Value.NativeVar;
                if (NativeFuncs.jundotsharp_variant_equals(variantValue, retValue).ToBool())
                {
                    return NativeFuncs.jundotsharp_dictionary_remove_key(
        ...
        public int Count
        {
            ...
            {
                var self = (jundot_dictionary)NativeValue;
                return NativeFuncs.jundotsharp_dictionary_count(ref self);
            }
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (jundot_dictionary)NativeValue;
            NativeFuncs.jundotsharp_dictionary_make_read_only(ref self);
        }
        ...
        public bool TryGetValue(Variant key, out Variant value)
        {
            var self = (jundot_dictionary)NativeValue;
            bool found = NativeFuncs.jundotsharp_dictionary_try_get_value(ref self,
                (jundot_variant)key.NativeVar, out jundot_variant retValue).ToBool();
        ...
        {
            var self = (jundot_dictionary)NativeValue;
            NativeFuncs.jundotsharp_dictionary_key_value_pair_at(ref self, index,
                out jundot_variant key,
                out jundot_variant value);
        ...
        {
            var self = (jundot_dictionary)NativeValue;
            NativeFuncs.jundotsharp_dictionary_to_string(ref self, out jundot_string str);
            using (str)
    ...
    internal interface IGenericJundotDictionary
    {
        public Dictionary UnderlyingDictionary { get; }
    }

    /// <summary>
    /// Typed wrapper around Jundot's Dictionary class, a dictionary of <typeparamref name="TKey"/>
    ...
    public class Dictionary<[MustBeVariant] TKey, [MustBeVariant] TValue> :
        ...
        IGenericJundotDictionary
    {
        private static jundot_variant ToVariantFunc(scoped in Dictionary<TKey, TValue> jundotDictionary) =>
            VariantUtils.CreateFromDictionary(jundotDictionary);

        private static Dictionary<TKey, TValue> FromVariantFunc(in jundot_variant variant) =>
        ...
        private void SetTypedForUnderlyingDictionary()
        {
            ...
            {
                NativeFuncs.jundotsharp_dictionary_set_typed(
                    ref self,
                    (uint)keyVariantType,
                    keyClassName,
                    keyScriptRef,
        ...
        Dictionary IGenericJundotDictionary.UnderlyingDictionary => _underlyingDict;

        internal ref jundot_dictionary.movable NativeValue
        {
        ...
        internal static Dictionary<TKey, TValue> CreateTakingOwnershipOfDisposableValue(
            jundot_dictionary nativeValueToOwn)
        ...
        /// <returns>A new Jundot Dictionary, or <see langword="null"/> if <see paramref="from"/> was null.</returns>
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                var self = (jundot_dictionary)_underlyingDict.NativeValue;

                if (NativeFuncs.jundotsharp_dictionary_try_get_value(ref self,
                        variantKey, out jundot_variant value).ToBool())
                {
                    using (value)
        ...
        public ICollection<TKey> Keys
        {
            get
            {
                jundot_array keyArray;
                var self = (jundot_dictionary)_underlyingDict.NativeValue;
                NativeFuncs.jundotsharp_dictionary_keys(ref self, out keyArray);
        ...
        public bool ContainsKey(TKey key)
        {
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (jundot_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.jundotsharp_dictionary_contains_key(ref self, variantKey).ToBool();
        }
        ...
        public bool Remove(TKey key)
        {
            ...
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (jundot_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.jundotsharp_dictionary_remove_key(ref self, variantKey).ToBool();
        }
        ...
        public static explicit operator Dictionary<TKey, TValue>(Variant from) =>
            from.AsJundotDictionary<TKey, TValue>();
