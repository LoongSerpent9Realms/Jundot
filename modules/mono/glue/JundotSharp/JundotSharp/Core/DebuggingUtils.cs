...
namespace Jundot
{
    internal static class DebuggingUtils
    {
        ...
        internal static void InstallTraceListener()
        {
            ...
            Trace.Listeners.Add(new JundotTraceListener());
        }

#pragma warning disable IDE1006 // Naming rule violation
        // ReSharper disable once InconsistentNaming
        [StructLayout(LayoutKind.Sequential)]
        internal ref struct jundot_stack_info
        {
            public jundot_string File;
            public jundot_string Func;
            public int Line;
        }

        // ReSharper disable once InconsistentNaming
        [StructLayout(LayoutKind.Sequential)]
        internal ref struct jundot_stack_info_vector
        {
            private IntPtr _writeProxy;
            private unsafe jundot_stack_info* _ptr;

            public readonly unsafe jundot_stack_info* Elements
            {
            ...
            public void Resize(int size)
            {
                ...
                var err = NativeFuncs.jundotsharp_stack_info_vector_resize(ref this, size);
                if (err != Error.Ok)
            ...
            public unsafe void Dispose()
            {
                if (_ptr == null)
                    return;
                NativeFuncs.jundotsharp_stack_info_vector_destroy(ref this);
                _ptr = null;
            }
        }
#pragma warning restore IDE1006
        ...
        internal static unsafe void GetCurrentStackInfo(void* destVector)
        {
            try
            {
                var vector = (jundot_stack_info_vector*)destVector;
                ...
                foreach (StackFrame frame in stackTrace.GetFrames())
                {
                    ...
                    jundot_stack_info* stackInfo = &vector->Elements[i];
