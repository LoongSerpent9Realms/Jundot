...
namespace Jundot
{
    ...
    public static class StringExtensions
    {
        ...
        {
            using jundot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.jundotsharp_string_capitalize(instanceStr, out jundot_string capitalized);
            using (capitalized)
        ...
        {
            using jundot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.jundotsharp_string_to_camel_case(instanceStr, out jundot_string camelCase);
            using (camelCase)
        ...
        {
            using jundot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.jundotsharp_string_to_pascal_case(instanceStr, out jundot_string pascalCase);
            using (pascalCase)
        ...
        {
            using jundot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.jundotsharp_string_to_snake_case(instanceStr, out jundot_string snakeCase);
            using (snakeCase)
        ...
        {
            using jundot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.jundotsharp_string_to_kebab_case(instanceStr, out jundot_string kebabCase);
            using (kebabCase)
...
#pragma warning restore CA5350
        ...
        {
            using jundot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.jundotsharp_string_simplify_path(instanceStr, out jundot_string simplifiedPath);
