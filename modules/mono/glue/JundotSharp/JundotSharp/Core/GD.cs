...
namespace Jundot
{
    ...
    public static partial class GD
    {
        ...
        public static Variant BytesToVar(Span<byte> bytes)
        {
            ...
            NativeFuncs.jundotsharp_bytes_to_var(varBytes, jundot_bool.False, out jundot_variant ret);
        ...
        {
            using var varBytes = Marshaling.ConvertSystemArrayToNativePackedByteArray(bytes);
            NativeFuncs.jundotsharp_bytes_to_var(varBytes, jundot_bool.True, out jundot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        /// <example>
        /// <code>
        /// Variant a = new Jundot.Collections.Array { 4, 2.5, 1.2 };
        ...
        {
            NativeFuncs.jundotsharp_convert((jundot_variant)what.NativeVar, (int)type, out jundot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            return NativeFuncs.jundotsharp_hash((jundot_variant)var.NativeVar);
        }
        ...
        {
            using var jundotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.jundotsharp_print(jundotStr);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Jundot.Collections.Array { 1, 2, 3 };
        ...
        {
            using var jundotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.jundotsharp_print_rich(jundotStr);
        }
        ...
        {
            using var jundotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.jundotsharp_printerr(jundotStr);
        }
        ...
        {
            using var jundotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.jundotsharp_printraw(jundotStr);
        }
        ...
        public static void PrintS(params object[] what)
        {
            ...
            using var jundotStr = Marshaling.ConvertStringToNative(message);
            NativeFuncs.jundotsharp_prints(jundotStr);
        }
        ...
        public static void PrintT(params object[] what)
        {
            string message = AppendPrintParams('\t', what);
            using var jundotStr = Marshaling.ConvertStringToNative(message);
            NativeFuncs.jundotsharp_printt(jundotStr);
        }

        [StackTraceHidden]
        private static void ErrPrintError(string message, jundot_error_handler_type type = jundot_error_handler_type.ERR_HANDLER_ERROR)
        {
            ...
            using jundot_string messageStr = Marshaling.ConvertStringToNative(message);
            using jundot_string callerNameStr = Marshaling.ConvertStringToNative(callerName);
            using jundot_string callerFilePathStr = Marshaling.ConvertStringToNative(callerFilePath);
            NativeFuncs.jundotsharp_err_print_error(callerNameStr, callerFilePathStr, callerLineNumber, messageStr, p_type: type);
        }

        /// <summary>
        /// Pushes an error message to Jundot's built-in debugger and to the OS terminal.
        ///
        ...
        /// <summary>
        /// Pushes a warning message to Jundot's built-in debugger and to the OS terminal.
        /// </summary>
        /// <example>
        /// <code>
        ...
        {
            ErrPrintError(message, type: jundot_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            ErrPrintError(AppendPrintParams(what), type: jundot_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            return NativeFuncs.jundotsharp_randf();
        }
        ...
        {
            return NativeFuncs.jundotsharp_randfn(mean, deviation);
        }
        ...
        {
            return NativeFuncs.jundotsharp_randi();
        }
        ...
        {
            NativeFuncs.jundotsharp_randomize();
        }
        ...
        {
            return NativeFuncs.jundotsharp_randf_range(from, to);
        }
        ...
        {
            return NativeFuncs.jundotsharp_randi_range(from, to);
        }
        ...
        {
            return NativeFuncs.jundotsharp_rand_from_seed(seed, out seed);
        }
        ...
        /// <example>
        /// <code>
        /// ulong mySeed = (ulong)GD.Hash("Jundot Rocks");
        /// GD.Seed(mySeed);
        ...
        {
            NativeFuncs.jundotsharp_seed(seed);
        }
        ...
        /// var b = GD.StrToVar(a).AsJundotDictionary(); // b is a Dictionary
        ...
        {
            using var jundotStr = Marshaling.ConvertStringToNative(str);
            NativeFuncs.jundotsharp_str_to_var(jundotStr, out jundot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            NativeFuncs.jundotsharp_var_to_bytes((jundot_variant)var.NativeVar, jundot_bool.False, out var varBytes);
            using (varBytes)
        ...
        {
            NativeFuncs.jundotsharp_var_to_bytes((jundot_variant)var.NativeVar, jundot_bool.True, out var varBytes);
            using (varBytes)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(varBytes);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Jundot.Collections.Dictionary { ["a"] = 1, ["b"] = 2 };
        ...
        {
            NativeFuncs.jundotsharp_var_to_str((jundot_variant)var.NativeVar, out jundot_string ret);
            using (ret)
        ...
        {
            using jundot_packed_byte_array src = Marshaling.ConvertSystemArrayToNativePackedByteArray(instance);
            NativeFuncs.jundotsharp_packed_byte_array_compress(src, (int)compressionMode, out var ret);
            using (ret)
        ...
        /// <para>Note: Decompression is not guaranteed to work with data not compressed by Jundot, for example if data compressed with the deflate compression mode lacks a checksum or header.</para>
        /// </summary>
        ...
        {
            using jundot_packed_byte_array src = Marshaling.ConvertSystemArrayToNativePackedByteArray(instance);
            NativeFuncs.jundotsharp_packed_byte_array_decompress(src, bufferSize, (int)compressionMode, out var ret);
            using (ret)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(ret);
        }
        ...
        {
            using jundot_packed_byte_array src = Marshaling.ConvertSystemArrayToNativePackedByteArray(instance);
            NativeFuncs.jundotsharp_packed_byte_array_decompress_dynamic(src, maxOutputSize, (int)compressionMode, out var ret);
            using (ret)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(ret);
        }
    }
