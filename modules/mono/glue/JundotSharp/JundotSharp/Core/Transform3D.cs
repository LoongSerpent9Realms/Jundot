...
namespace Jundot
{
    ...
    /// It consists of a <see cref="Jundot.Basis"/> (first 3 columns) and a
    /// <see cref="Vector3"/> for the origin (last column).
    ///
    /// For more information, read this documentation article:
    /// https://docs.jundotengine.org/en/latest/tutorials/math/matrices_and_transforms.html
    /// </summary>
    [Serializable]
    ...
    {
        /// <summary>
        /// The <see cref="Jundot.Basis"/> of this transform. Contains the X, Y, and Z basis
        ...
        /// </summary>
        /// <param name="basis">The <see cref="Jundot.Basis"/> to create the basis from.</param>
        /// <param name="origin">The origin vector, or column index 3.</param>
