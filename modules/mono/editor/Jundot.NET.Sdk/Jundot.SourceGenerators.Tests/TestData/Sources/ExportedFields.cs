...
public partial class ExportedFields : JundotObject
{
    ...
    [Export] private JundotObject[] _fieldJundotObjectOrDerivedArray = { null };
    ...
    // Classes
    [Export] private JundotObject _fieldJundotObjectOrDerived;
    [Export] private Jundot.Texture _fieldJundotResourceTexture;
    [Export] private Jundot.Texture _fieldJundotResourceTextureWithInitializer = new() { ResourceName = "" };
    ...
    [Export]
    private Jundot.Collections.Dictionary _fieldJundotDictionary = new() { { "foo", 10 }, { Vector2.Up, Colors.Chocolate } };

    [Export]
    private Jundot.Collections.Array _fieldJundotArray = new() { "foo", 10, Vector2.Up, Colors.Chocolate };

    [Export]
    private Jundot.Collections.Dictionary<string, bool> _fieldJundotGenericDictionary = new() { { "foo", true }, { "bar", false } };

    [Export]
    private Jundot.Collections.Array<int> _fieldJundotGenericArray = new() { 0, 1, 2, 3, 4, 5, 6 };
}
