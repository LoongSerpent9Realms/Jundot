...
namespace Jundot.SourceGenerators.Sample
{
    ...
    public partial class ExportedProperties : JundotObject
    {
        ...
        [Export]
        private Jundot.Collections.Dictionary PropertyJundotDictionary { get; set; } =
            new() { { "foo", 10 }, { Vector2.Up, Colors.Chocolate } };

        [Export]
        private Jundot.Collections.Array PropertyJundotArray { get; set; } =
            new() { "foo", 10, Vector2.Up, Colors.Chocolate };

        [Export]
        private Jundot.Collections.Dictionary<string, bool> PropertyJundotGenericDictionary { get; set; } =
            new() { { "foo", true }, { "bar", false } };

        [Export]
        private Jundot.Collections.Array<int> PropertyJundotGenericArray { get; set; } =
            new() { 0, 1, 2, 3, 4, 5, 6 };
    }
}
