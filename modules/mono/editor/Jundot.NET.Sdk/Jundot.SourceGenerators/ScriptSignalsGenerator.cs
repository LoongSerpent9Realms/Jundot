...
namespace Jundot.SourceGenerators
{
    ...
    public class ScriptSignalsGenerator : ISourceGenerator
    {
        ...
        {
            if (context.IsJundotSourceGeneratorDisabled("ScriptSignals"))
                return;
        ...
        )
        {
            ...
            // Generate GetJundotSignalList

            if (jundotSignalDelegates.Count > 0)
            {
                ...
                source.Append("    /// <summary>\n")
                    ...
                    .Append("    /// This method is used by Jundot to register the available signals in the editor.\n")
                ...
                source.Append("    internal new static ")
                    .Append(ListType)
                    .Append(" GetJundotSignalList()\n    {\n");

                source.Append("        var signals = new ")
                    .Append(ListType)
                    .Append("(")
                    .Append(jundotSignalDelegates.Count)
                    .Append(");\n");

                foreach (var signalDelegateData in jundotSignalDelegates)
                {
            ...
            // Generate RaiseJundotClassSignalCallbacks
            ...
            if (jundotSignalDelegates.Count > 0)
            {
                ...
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append(
                    "    protected override void RaiseJundotClassSignalCallbacks(in jundot_string_name signal, ");
                source.Append("NativeVariantPtrArgs args)\n    {\n");

                foreach (var signal in jundotSignalDelegates)
                {
                    GenerateSignalEventInvoker(signal, source);
                }

                source.Append("        base.RaiseJundotClassSignalCallbacks(signal, args);\n");
            ...
            if (jundotSignalDelegates.Count > 0)
            {
                ...
                source.Append("        return base.HasJundotClassSignal(signal);\n");
        ...
        private static MethodInfo DetermineMethodInfo(JundotSignalDelegateData signalDelegateData)
        {
        ...
        private static void GenerateSignalEventInvoker(
            JundotSignalDelegateData signal,
            StringBuilder source
        )
        {
