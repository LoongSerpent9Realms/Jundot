...
#nullable enable
        ...
        public void BuildProject()
        {
            ...
            JundotSharpEditor.Instance.GetNode<HotReloadAssemblyWatcher>("HotReloadAssemblyWatcher").RestartTimer();
        ...
        private void OpenLogsFolder() => OS.ShellOpen(
            $"file://{JundotSharpDirs.LogsDirPathFor("Debug")}"
        );
        ...
        public void OnBeforeSerialize()
        {
            ...
            // NOTE:
            // Currently, JundotTools is loaded in its own load context. This load context is not reloaded, but the script still are.
