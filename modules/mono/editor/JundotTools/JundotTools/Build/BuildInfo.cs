...
namespace JundotTools.Build
{
    ...
    public sealed partial class BuildInfo : RefCounted // TODO Remove RefCounted once we have proper serialization
    {
        ...
        public Jundot.Collections.Array CustomProperties { get; private set; } = new();

        public string LogsDirPath => JundotSharpDirs.LogsDirPathFor(Solution, Configuration);
        ...
        // Needed for instantiation from Jundot, after reloading assemblies
        private BuildInfo()
        {
