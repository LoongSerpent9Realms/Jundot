...
namespace JundotTools.Build
{
    public static class BuildManager
    {
        ...
        {
            var dllName = $"{JundotSharpDirs.ProjectAssemblyName}.dll";
            var path = Path.Combine(JundotSharpDirs.ProjectBaseOutputPath, "Debug", dllName);
        ...
        {
            var plugin = JundotSharpEditor.Instance;
        ...
        {
            var buildInfo = new BuildInfo(JundotSharpDirs.ProjectSlnPath, JundotSharpDirs.ProjectCsProjPath, configuration,
            ...
            if (platform != null || Utils.OS.PlatformNameMap.TryGetValue(OS.GetName(), out platform))
                buildInfo.CustomProperties.Add($"JundotTargetPlatform={platform}");

            if (Internal.JundotIsRealTDouble())
                buildInfo.CustomProperties.Add("JundotFloat64=true");
        ...
        public static bool EditorBuildCallback()
        {
            ...
            if (JundotSharpEditor.Instance.SkipBuildBeforePlaying)
